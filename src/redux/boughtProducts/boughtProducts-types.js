...
const CHANGE_AMOUNT_PRODUCTS_REQUEST = "changeAmountProducts/request";
const CHANGE_AMOUNT_PRODUCTS_SUCCESS = "changeAmountProducts/success";
const CHANGE_AMOUNT_PRODUCTS_ERROR = "changeAmountProducts/error";
...
export default {
  ...
  CHANGE_AMOUNT_PRODUCTS_REQUEST,
  CHANGE_AMOUNT_PRODUCTS_SUCCESS,
  CHANGE_AMOUNT_PRODUCTS_ERROR,
};
